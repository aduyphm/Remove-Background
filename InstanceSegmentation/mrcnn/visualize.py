...
def display_instances(image, boxes, masks, class_ids, class_names,
                      ...
                      colors=None, captions=None, outname='output.jpg'):
    """
    ...
    plt.savefig(os.path.join('final_results', outname), bbox_inches='tight', pad_inches=0)
...
def display_blurred(image, boxes, masks, class_ids, class_names,
                            keys=None, figsize=(16,16), ax=None, outname="output.jpg"):
    """
    boxes: [num_instance, (y1, x1, y2, x2, class_id)] in image coordinates.
    masks: [height, width, num_instances]
    class_ids: [num_instances]
    ...
    plt.imsave(os.path.join('blur', outname), blurred_image.astype(np.uint8))
